...
const Auth = (props) => {
  ...
  return (
    <div className="dark:bg-gray-bg rounded-lg ">
      <section className="flex justify-center items-center">
        ...
        >
          ...
          >
            <fieldset className=" rounded-xl border border-solid border-gray-300 px-12 py-5">
              <legend
