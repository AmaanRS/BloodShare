...
const Auth = (props) => {
    ...
    async function handleOtpSubmit() {
        ...
        const res = await axios.post(`/auth/verify_otp/check`, formData, { withCredentials: true })
                                        ...
                                        handle === "bank" ?
                                            <>
                                                ...
                                                <div><label for="category" className="font-semibold  leading-8">Category:<font color="red">*</font></label>
                                                    <select disabled={enterOtp}
                                                        name="category" id="category" onChange={(e) => setCategory(e.target.value)} className="w-full p-3 text-md border border-silver rounded" >
                                        ...
                                        handle !== "bank" && <><div><label className="font-semibold  leading-8">Age:<font color="red">*</font></label>
                                            ...
                                            <div><label for="gender" className="font-semibold  leading-8">Gender:<font color="red">*</font></label>
                                                <select
                                                    ...
                                                    name="gender" id="gender" onChange={(e) => setGender(e.target.value)} className="w-full p-3 text-md border border-silver rounded" >
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    name="blood" id="state" onChange={(e) => setBlood(e.target.value)} className="w-full p-3 text-md border border-silver rounded">
                                                    {
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                name="state" id="state" onChange={(e) => { setState(e.target.value); setDistrict(0); }} className="w-full p-3 text-md border border-silver rounded">
                                                {
                                        ...
                                        <div><label for="district" className="font-semibold  leading-8">District:<font color="red">*</font></label>
                                            <select
                                                ...
                                                name="district" id="district" onChange={(e) => setDistrict(e.target.value)} className="w-full p-3 text-md border border-silver rounded">
                                                {
                                        ...
                                        {enterOtp &&
                                            ...
                                            <div className="my-20">
                                                <label className="font-semibold leading-7">Enter OTP<font color="red">*</font></label>
                                                <input
                                                    className="w-full p-3 text-md border border-silver rounded"
                                                    type="number"
                                                    ...
                                                    required
                                                />
                                                <button type="button" className="bg-green text-center text-white-900 rounded-lg mt-4 px-4 py-2" onClick={handleOtpSubmit}>
                                                    SUBMIT OTP
                                                </button>
                                            </div>
                                        }
                                            ...
                                            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(0, 1fr))", gap: "1rem" }}>
                                                ...
                                                <div style={{ gridColumn: "1", gridRow: "1/2" }}>
                                                    ...
                                                    <input
                                                        ...
                                                        required
                                                    />
                                                    <button disabled={enterOtp} type="button" className="bg-purple text-center text-white-900 rounded-lg mt-4 px-4 py-2" onClick={() => fetchGeo()}>
                                                        Fetch Geocode
                                                    </button>
                                                    {enterOtp &&
